package it.forgottenworld.townycustomupkeep.commands;

import com.palmergames.bukkit.towny.TownyAPI;
import com.palmergames.bukkit.towny.exceptions.NotRegisteredException;
import com.palmergames.bukkit.towny.object.Nation;
import com.palmergames.bukkit.towny.object.Town;
import it.forgottenworld.townycustomupkeep.Config;
...
public class  CtuCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull org.bukkit.command.Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if(args.length > 0){
            if(args[0].equalsIgnoreCase("reload")){
                try{
                    FWTownyCustomUpkeep.INSTANCE.loadConfig();
                ...
                if(args.length >= 4){
                    if(args[1].equalsIgnoreCase("town")){
                        try {
                            ...
                            Config config = FWTownyCustomUpkeep.INSTANCE.getCustomUpkeepList();
